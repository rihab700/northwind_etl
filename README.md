...
The 'northwind' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `northwind` directory. We recommend making
...
`[dev yourname] northwind_job` to your workspace.
...
When deploying to this target, note that the default job at resources/northwind.job.yml
